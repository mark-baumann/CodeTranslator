...
const createPrompt = (
  ...
  if (inputLanguage === 'Natural Language') {
    ...
    please make also a comment about the code. 
    ...
    return endent` 
      You are an expert programmer in all programming languages.  Translate the "${inputLanguage}" code to "${outputLanguage}" code. ${textboxValue}   Do not include \`\`\`.
...
export const OpenAIStream = async (
  ...
  const prompt = createPrompt(inputLanguage, outputLanguage, inputCode, textBoxValue);
